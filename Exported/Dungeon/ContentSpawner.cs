...
namespace RedPanda.Dungeon
{
    public class ContentSpawner : MonoBehaviour
    {
        ...
        public Helpers.DynamicRandomSelector<GameObject> randomContentPicker;
        public List<WeightedContent> randomContentItems;
        public GameObject contentParent;

        private void Start()
        {
            randomContentPicker = new Helpers.DynamicRandomSelector<GameObject>();
